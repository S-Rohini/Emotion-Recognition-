...
# Updated Porcupines Optimization Algorithm (UPOA) Starting Line No. 28
def Proposed(X, fitness_func, lb, ub, max_iter):
    ...
    for t in range(max_iter):
        for i in range(n):
            ...
            r1 = CurrentFit / ((BestFit ** 2) + WorstFit + math.sqrt(MeanFit))
